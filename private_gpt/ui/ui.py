...
from gradio.themes.utils.colors import slate,teal  # type: ignore
...
class PrivateGptUi:
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            # Add the summarise_button to the blocks
            
            
            with gr.Row():
                gr.HTML(f"""
                <div class='logo'><img src={logo_svg} alt='mAI-Mail'></div>
                """)
            ...
            with gr.Row(equal_height=False):
                ...
                with gr.Column(scale=7, elem_id="col"):
                    ...
                    summarise_button = gr.Button("Summarise all the mails", size="sm")
                    def button_fn():
                        return "Summarise all the mails"
                    summarise_button.click(self._summarise_mails)
                    
                    # button = gr.Button("Summarise",size="sm")/
                    _ = gr.ChatInterface(
                        self._chat,
                        chatbot=gr.Chatbot(
